...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            ...
            <?php
            $id = $_GET['id'];
            $query = "SELECT * FROM tblitems WHERE advertisementID = $id";
        ...
        <?php
        $mysqlQ = "SELECT * FROM tblitems WHERE advertisementID = $id";
        $resultQ = mysqli_query($connect, $mysqlQ);
        ...
        ?>
                <div class="single-pro-details">
                    <h6>Home / T-Shirt</h6>
                    <h4><?php echo $rowQ['category']?>'s <?php echo $rowQ['productName']?> <?php echo $rowQ['description']?></h4>
                    <h2>Rs. <?php echo $rowQ['item_price']?></h2>
                    <select>
